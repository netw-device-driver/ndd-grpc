...
type Status struct {
	...
	Status    Status_ResourceStatus `protobuf:"varint,1,opt,name=status,proto3,enum=config.Status_ResourceStatus" json:"status,omitempty"`
	Path      *Path                 `protobuf:"bytes,2,opt,name=path,proto3" json:"path,omitempty"`
	Data      []byte                `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
	Deviation []*Deviation          `protobuf:"bytes,4,rep,name=deviation,proto3" json:"deviation,omitempty"`
}
...
var file_config_configpb_config_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x79, 0x22, 0x94, 0x02, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x35,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x20, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x02, 0x20,
	...
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x2f, 0x0a, 0x09, 0x64,
	0x65, 0x76, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11,
	0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x44, 0x65, 0x76, 0x69, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x09, 0x64, 0x65, 0x76, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x6c, 0x0a, 0x0e,
	...
	0x02, 0x38, 0x01, 0x32, 0xc5, 0x01, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72,
	...
	0x66, 0x69, 0x67, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x38, 0x5a, 0x36, 0x67,
...
var file_config_configpb_config_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_config_configpb_config_proto_goTypes = []interface{}{
	...
	nil,                        // 8: config.PathElem.KeyEntry
}
var file_config_configpb_config_proto_depIdxs = []int32{
	6,  // 0: config.Request.path:type_name -> config.Path
	0,  // 1: config.Status.status:type_name -> config.Status.ResourceStatus
	6,  // 2: config.Status.path:type_name -> config.Path
	...
	8,  // 6: config.PathElem.key:type_name -> config.PathElem.KeyEntry
	1,  // 7: config.Configuration.Create:input_type -> config.Request
	2,  // 8: config.Configuration.Get:input_type -> config.ResourceKey
	1,  // 9: config.Configuration.Update:input_type -> config.Request
	2,  // 10: config.Configuration.Delete:input_type -> config.ResourceKey
	3,  // 11: config.Configuration.Create:output_type -> config.Reply
	4,  // 12: config.Configuration.Get:output_type -> config.Status
	3,  // 13: config.Configuration.Update:output_type -> config.Reply
	3,  // 14: config.Configuration.Delete:output_type -> config.Reply

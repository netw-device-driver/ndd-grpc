...
const (
	...
	Status_DeletePending Status_ResourceStatus = 3
)
...
type Status struct {
	...
	Status    Status_ResourceStatus `protobuf:"varint,2,opt,name=status,proto3,enum=config.Status_ResourceStatus" json:"status,omitempty"`
...
var file_config_configpb_config_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x79, 0x22, 0xe4, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16,
	0x0a, 0x06, 0x65, 0x78, 0x69, 0x73, 0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06,
	0x65, 0x78, 0x69, 0x73, 0x74, 0x73, 0x12, 0x35, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53,
	...
	0x61, 0x12, 0x2f, 0x0a, 0x09, 0x64, 0x65, 0x76, 0x69, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04,
	...
	0x6f, 0x6e, 0x22, 0x46, 0x0a, 0x0e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x74,
	...
	0x61, 0x69, 0x6c, 0x65, 0x64, 0x10, 0x02, 0x12, 0x11, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x10, 0x03, 0x22, 0x43, 0x0a, 0x09, 0x44, 0x65,
...
var file_config_configpb_config_proto_depIdxs = []int32{
	...
	5,  // 2: config.Status.deviation:type_name -> config.Deviation
	6,  // 3: config.Deviation.path:type_name -> config.Path
	7,  // 4: config.Path.elem:type_name -> config.PathElem
	8,  // 5: config.PathElem.key:type_name -> config.PathElem.KeyEntry
	1,  // 6: config.Configuration.Create:input_type -> config.Request
	2,  // 7: config.Configuration.Get:input_type -> config.ResourceKey
	1,  // 8: config.Configuration.Update:input_type -> config.Request
	2,  // 9: config.Configuration.Delete:input_type -> config.ResourceKey
	3,  // 10: config.Configuration.Create:output_type -> config.Reply
	4,  // 11: config.Configuration.Get:output_type -> config.Status
	3,  // 12: config.Configuration.Update:output_type -> config.Reply
	3,  // 13: config.Configuration.Delete:output_type -> config.Reply

...
type Deviation_Action int32

const (
	Deviation_Delete Deviation_Action = 0
	Deviation_Update Deviation_Action = 1
)

// Enum value maps for Deviation_Action.
var (
	Deviation_Action_name = map[int32]string{
		0: "Delete",
		1: "Update",
	}
	Deviation_Action_value = map[string]int32{
		"Delete": 0,
		"Update": 1,
	}
)

func (x Deviation_Action) Enum() *Deviation_Action {
	p := new(Deviation_Action)
	*p = x
	return p
}

func (x Deviation_Action) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Deviation_Action) Descriptor() protoreflect.EnumDescriptor {
	return file_config_configpb_config_proto_enumTypes[1].Descriptor()
}

func (Deviation_Action) Type() protoreflect.EnumType {
	return &file_config_configpb_config_proto_enumTypes[1]
}

func (x Deviation_Action) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Deviation_Action.Descriptor instead.
func (Deviation_Action) EnumDescriptor() ([]byte, []int) {
...
type Deviation struct {
	...
	Action Deviation_Action `protobuf:"varint,3,opt,name=action,proto3,enum=config.Deviation_Action" json:"action,omitempty"`
}
...
func (x *Deviation) GetAction() Deviation_Action {
	if x != nil {
		return x.Action
	}
...
var file_config_configpb_config_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xc5, 0x02, 0x0a, 0x0d, 0x43, 0x6f, 0x6e,
...
var file_config_configpb_config_proto_goTypes = []interface{}{
	...
	(Deviation_Action)(0),      // 1: config.Deviation.Action
...
var file_config_configpb_config_proto_depIdxs = []int32{
	...
	11, // 5: config.Deviation.path:type_name -> config.Path
	1,  // 6: config.Deviation.action:type_name -> config.Deviation.Action
